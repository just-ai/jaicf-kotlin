...
class BotEngine(
    ...
    override fun process(
        ...
        processBotRequest(botContext, request, reactions, requestContext, executionContext)
    ...
    private fun processBotRequest(
        ...
        try {
            ...
            val exception = BotExecutionException(e, botContext.dialogContext.currentState)
