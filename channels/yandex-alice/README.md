...
Здесь доступен готовый шаблон голосового навыка на JAICF, который можно запустить на сервере Heroku одним нажатием, а затем изменять код навыка как вам нужно, чтобы он выполнял нужные вам функции.
